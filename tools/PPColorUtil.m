...
@implementation PPColorUtil


+ (UIColor *)colorFromString:(NSString *)aColorString
{
    return [self colorFromString:aColorString alpha:1.0];
}
...
+ (UIColor *)colorFromString:(NSString *)aColorString alpha:(CGFloat)aAlpha
{
    ...
    if (aColorString.length == 6) {
        ...
        return [UIColor colorWithRed:a[0]/255.0f green:a[1]/255.0f blue:a[2]/255.0f alpha:aAlpha];
        ...
        return [UIColor colorWithWhite:gray/255.0f alpha:aAlpha];
    }
    return nil;
}
