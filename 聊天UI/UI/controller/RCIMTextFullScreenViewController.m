//
//  RCIMFullScreenViewController.m
//  rongchat
//
...
@interface RCIMTextFullScreenViewController()
...
@property (nonatomic, copy) RCIMRemoveFromWindowHandler removeFromWindowHandler;
@end

@implementation RCIMTextFullScreenViewController
