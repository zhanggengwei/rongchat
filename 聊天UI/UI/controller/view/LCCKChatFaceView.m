...
@interface LCCKChatFaceView ()<UIScrollViewDelegate,RCSwipeViewDelegate,RCSwipeViewDataSource,LCCKFacePageViewDelegate>

@property (nonatomic, strong) RCSwipeView *swipeView;
...
- (RCSwipeView *)swipeView {
    if (!_swipeView) {
        _swipeView = [[RCSwipeView alloc] init];
