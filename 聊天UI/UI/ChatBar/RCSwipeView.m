...
@implementation NSObject (RCSwipeView)

- (CGSize)swipeViewItemSize:(__unused RCSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused RCSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused RCSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused RCSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused RCSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused RCSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused RCSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused RCSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused RCSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused RCSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface RCSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<RCSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<RCSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(RCSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case RCSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == RCSwipeViewAlignmentCenter)
        {
...
{
    //get number of items
    _numberOfItems = [_dataSource numberOfItemsInRCSwipeView:self];
