...
@interface RCIMImageObserver : NSObject
...
@implementation RCIMImageObserver
...
@implementation UIImageView (RCIMExtension)
...
- (RCIMImageObserver *)lcck_imageObserver {
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
    RCIMImageObserver *imageObserver = objc_getAssociatedObject(self, @selector(imageObserver));
#pragma clang diagnostic pop
    
    if (!imageObserver) {
        imageObserver = [[RCIMImageObserver alloc] initWithImageView:self];
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wundeclared-selector"
