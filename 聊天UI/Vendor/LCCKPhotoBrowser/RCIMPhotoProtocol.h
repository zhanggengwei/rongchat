...
#import "RCIMPBConstants.h"

// Name of notification used when a photo has completed loading process
// Used to notify browser display the image
#define RCIMPhoto_LOADING_DID_END_NOTIFICATION @"RCIMPhoto_LOADING_DID_END_NOTIFICATION"
...
// Otherwise you can use the RCIMPhoto object or subclass it yourself to
// store more information per photo.
//
// You can see the RCIMPhoto class for an example implementation of this protocol
//
@protocol RCIMPhoto <NSObject>
...
// See RCIMPhoto object for an example implementation.
