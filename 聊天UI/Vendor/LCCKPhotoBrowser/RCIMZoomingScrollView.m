...
@interface RCIMZoomingScrollView ()
//@property (nonatomic, weak) RCIMPhotoBrowser *photoBrowser;
@property (nonatomic, weak) id<RCIMZoomingScrollViewDelegate> photoDelegate;
@property (nonatomic, strong) UILongPressGestureRecognizer *longPress;
- (void)handleSingleTap:(CGPoint)touchPoint;
- (void)handleDoubleTap:(CGPoint)touchPoint;
@end

@implementation RCIMZoomingScrollView
...
- (void)dealloc {
//    RCIMLog(@"%@, %@, %@", NSStringFromClass([self class]), NSStringFromSelector(_cmd), [NSString stringWithFormat:@"%i", __LINE__]);
}
...
//        self.photoBrowser = browser;
		...
		_tapView = [[RCIMTapDetectingView alloc] initWithFrame:self.bounds];
		...
		// Image view
		_photoImageView = [[RCIMTapDetectingImageView alloc] initWithFrame:CGRectZero];
...
- (void)setPhoto:(id<RCIMPhoto>)photo {
...
- (void)setProgress:(CGFloat)progress forPhoto:(RCIMPhoto*)photo {
    RCIMPhoto *p = (RCIMPhoto*)self.photo;
...
- (void)handleSingleTapInZoomingScrollView:(RCIMZoomingScrollView *)zoomingScrollView {
