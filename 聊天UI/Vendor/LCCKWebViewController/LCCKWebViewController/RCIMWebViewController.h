...
/**
 * The `RCIMWebViewController` class is a view controller that displays the contents of a URL
 ...
 */
@interface RCIMWebViewController : UIViewController <UIWebViewDelegate>
