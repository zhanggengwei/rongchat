...
#import "RCIMWebViewProgress.h"
#import "RCIMWebViewProgressView.h"

@interface RCIMWebViewController () <RCIMWebViewProgressDelegate>
...
@property (nonatomic, strong) RCIMWebViewProgress *progressProxy;
@property (nonatomic, strong) RCIMWebViewProgressView *progressView;
...
@implementation RCIMWebViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _progressProxy = [[RCIMWebViewProgress alloc] init];
    ...
    _progressView = [[RCIMWebViewProgressView alloc] initWithFrame:barFrame];
