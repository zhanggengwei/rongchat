...
const float RCIMInitialProgressValue = 0.1f;
const float RCIMInteractiveProgressValue = 0.5f;
const float RCIMFinalProgressValue = 0.9f;

@implementation RCIMWebViewProgress
{
...
- (void)startProgress
{
    if (_progress < RCIMInitialProgressValue) {
        [self setProgress:RCIMInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? RCIMFinalProgressValue : RCIMInteractiveProgressValue;
